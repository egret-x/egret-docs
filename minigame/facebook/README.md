...
## 创建 Facebook Instant Games 应用[​](#创建-facebook-instant-games-应用 "创建 Facebook Instant Games 应用的直接链接")
...
## 创建 Egret 项目[​](#创建-egret-项目 "创建 Egret 项目的直接链接")

创建Egret项目，扩展库中需要选择`Facebook Instant Games`

![alt text](image-6.png)

## 编写代码或迁移您的项目[​](#编写代码或迁移您的项目 "编写代码或迁移您的项目的直接链接")
